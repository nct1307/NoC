...
entity noc_system is
    generic(
        ...
        enable_link_pm  : integer := 0;
        flit_data_width : integer := 32;
    ...
    port(
        clk             : in     vl_logic;
        rst             : in     vl_logic;
        error_leds      : out    vl_logic_vector(8 downto 0);
        fpga_led_matrix_out: out    vl_logic_vector(31 downto 0);
        fpga_timer_debug: out    vl_logic_vector(31 downto 0);
        fpga_gpio_pins  : inout  vl_logic_vector(31 downto 0);
